...
urlpatterns = [
    ...
    django.urls.path('ticket/<int:ticket_id>/update/', auth_views.ticket_update, name='ticket_update'),  # <-- Manquait ici
    django.urls.path('ticket/<int:ticket_id>/delete/', auth_views.ticket_delete, name='ticket_delete'),  # <-- Manquait ici
    ...
    django.urls.path('review/<int:review_id>/update/', auth_views.review_update, name='review_update'),  # <-- Manquait ici
    django.urls.path('review/<int:review_id>/delete/', auth_views.review_delete, name='review_delete'),  # <-- Manquait ici
]